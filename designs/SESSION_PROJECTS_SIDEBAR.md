...
- Issue: [#863](https://github.com/codify-ai/codify/issues/863)
- Builds on: PR [#869](https://github.com/codify-ai/codify/pull/869) (community implementation of "collections")
- Status: Draft
- Author: Serena Ruan
...
- Collapsible, persisted in the existing `codify:collapsed-sidebar-sections`

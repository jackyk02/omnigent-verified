...
Covers the end-to-end contract — YAML parser (via the codify
inner-stack loader, which is the entry point every YAML spec
flows through today), the spec translator, and the codify
...
# ---------------------------------------------------------------
# Parser (codify inner-stack loader) coverage.
# ---------------------------------------------------------------

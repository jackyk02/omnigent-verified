...
from codify.harness_plugins import KIRO_NATIVE_CODING_AGENT, PI_NATIVE_CODING_AGENT
...
def test_public_agent_name_passes_through_regular_names() -> None:
    ...
    Regular Codify agents have user-meaningful names that are safe to expose,

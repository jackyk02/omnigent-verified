...
from codify.kimi_native_forwarder import KimiWireItem, read_kimi_wire_items
from codify.kiro_native_session_forwarder import (
    KiroConversationMessage,
    parse_kiro_jsonl_line,
)
from codify.session_import import local as local_import
...
def test_load_opencode_session_preserves_messages_files_and_tools(
    ...
    """The public export maps ordered parts to durable Codify items."""
    export = {
        "info": {
            "id": "ses_import",
            "directory": "/repo",
...
def test_load_claude_session_normalizes_parent_transcript(tmp_path: Path) -> None:
    """Claude parent messages and tools become ordinary Codify items."""

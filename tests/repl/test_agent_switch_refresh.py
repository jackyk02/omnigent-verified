...
from codify.repl._repl import _refresh_session_metadata, _SessionsChatReplAdapter
...
class _SnapshotClient:
    """
    Codify client stub exposing only the ``sessions.get`` surface.
...
class _RaisingClient:
    """Codify client stub whose ``sessions.get`` always fails."""
...
def _make_adapter(client: object, agent_name: str = "nessie") -> _SessionsChatReplAdapter:
    ...
    :param client: Codify client (stub) handed to the adapter.

...
:func:`codify.repl._repl.handle_slash_command` against a host /
...
async def test_context_free_space_count_matches_its_percentage(
    ...
    from codify.repl._repl import _CONTEXT_COMPACTION_TRIGGER
...
async def test_context_uses_host_tokens_used_when_set(
    ...
    monkeypatch.setattr("codify.runtime.compaction.count_tokens", _should_not_count)
    ...
    monkeypatch.setattr("codify.repl._repl._fetch_context_items", _should_not_fetch)

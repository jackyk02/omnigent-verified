...
from codify.repl._repl import COMMANDS, handle_slash_command
from codify.repl._session_log import collect_log_files, write_logs_zip
...
async def test_logs_command_creates_current_session_zip_at_requested_path(
    ...
    import codify.cli_diagnostics as cli_diagnostics
    ...
    import codify.repl._session_log as session_log

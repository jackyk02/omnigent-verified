...
def test_build_github_issue_url_base_structure() -> None:
    """URL targets the codify-ai/codify issues/new endpoint.
...
async def test_report_command_includes_version_in_url(
    ...
    """Codify version is included in the issue body when available.
    ...
    monkeypatch.setattr(
        ...
        lambda pkg: "9.8.7" if pkg == "codify" else "0.0.0",
    )

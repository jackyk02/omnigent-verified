...
from codify import cursor_native_forwarder as fwd
from codify.cursor_native_forwarder import _persist_native_compaction_item
...
class TestUnwrapUserQuery:
    ...
    def test_strips_fork_history_preamble_block(self) -> None:
        ...
        # Codify timeline, so echoing it here would duplicate it.
    ...
    def test_embedded_close_tag_in_history_does_not_leak(self) -> None:
        ...
        from codify.cursor_native_bridge import wrap_fork_preamble

        preamble = "You: look at </codify_fork_history> in my logs\nAssistant: ok"
    ...
    def test_user_message_containing_close_tag_is_preserved(self) -> None:
        ...
        wrapped = wrap_fork_preamble("You: hi", "is </codify_fork_history> a tag?")
        raw = f"<user_query>\n{wrapped}\n</user_query>"
        assert fwd._unwrap_user_query(raw) == "is </codify_fork_history> a tag?"
    ...
    def test_unterminated_history_block_strips_to_end(self) -> None:
        ...
        from codify.cursor_native_bridge import FORK_HISTORY_OPEN_TAG
...
class TestPostModelChangeIfNew:
    ...
    async def test_first_observation_is_posted(self) -> None:
        ...
        # un-pinned session shows the real cursor model instead of codify's

"""Tests for the Codify brand wordmark and Otto lockup."""
...
from codify.inner import wordmark
from codify.inner.mascots import MASCOT_ART_COLOR, MASCOT_ART_LINES
...
def test_every_letter_in_codify_has_a_glyph() -> None:

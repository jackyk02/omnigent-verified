...
def test_inline_text_file_data_variants() -> None:
    from codify.inner.goose_executor import _inline_text_file_data
...
def test_resolve_os_env_default(monkeypatch) -> None:
    from codify.inner import goose_harness
...
def test_build_goose_executor_reads_env(monkeypatch) -> None:
    ...
    monkeypatch.delenv("CODIFY_GOOSE_PATH", raising=False)

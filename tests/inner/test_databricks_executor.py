...
from codify.inner.databricks_executor import (  # noqa: E402
    DatabricksAuthError,
...
def test_resolve_databricks_auth_invalid_profile_raises_clear_error(
    ...
    import codify.inner.databricks_executor as db_exec
    from codify.inner.databricks_executor import (
        DatabricksAuthError,
        _resolve_databricks_auth,
    )
...
def test_resolve_databricks_auth_env_profile_falls_back_to_ambient_with_warning(
    ...
    with caplog.at_level(logging.WARNING, logger="codify.inner.databricks_executor"):
...
def test_claude_sdk_executor_reuses_api_key_helper_between_turns(
    ...
    def _counting_resolve(
        ...
        *,
        ...
        return {
            ...
            "CODIFY_CLAUDE_API_KEY_HELPER": f"helper-{call_count}",
    ...
    executor._extra_env = {
        "CODIFY_CLAUDE_API_KEY_HELPER": "helper-initial",
        "ANTHROPIC_BASE_URL": "https://host/ai-gateway/anthropic",
        "CLAUDE_CODE_API_KEY_HELPER_TTL_MS": "900000",
        "CLAUDE_CODE_DISABLE_EXPERIMENTAL_BETAS": "1",
    }
    ...
    async def _trigger_refresh():
        ...
        try:
            ...
            pass
        return executor._extra_env.get("CODIFY_CLAUDE_API_KEY_HELPER")
...
def test_bearer_auth_current_token_none_for_non_bearer(headers: dict[str, str]) -> None:
    ...
    raw header would feed callers a credential the Codify server can't use.
    """
...
# ── host-keyed resolution (codify login pointer records) ─────────
...
def test_profiles_for_host_normalizes_scheme_and_slash(
    ...
    """
    from codify.inner.databricks_executor import _databrickscfg_profiles_for_host

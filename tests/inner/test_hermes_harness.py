...
from codify.inner import hermes_harness
...
def test_harness_module_registered_in_module_registry() -> None:
    ...
    """
    assert _HARNESS_MODULES.get("hermes") == "codify.inner.hermes_harness"
...
def test_executor_factory_reads_env_vars(
    ...
    monkeypatch.delenv("CODIFY_HERMES_PATH", raising=False)

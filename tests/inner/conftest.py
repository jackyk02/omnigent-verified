...
def _stub_executor_catalog_defaults(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("codify.model_catalog.resolve_catalog_model", _resolve)
...
def model_name(request: pytest.FixtureRequest) -> str:
    ...
    spread when ``CODIFY_TEST_MODEL_SPREAD`` is on.
...
def _capture_codex_executor_diag(caplog: pytest.LogCaptureFixture) -> None:
    ...
    caplog.set_level(logging.INFO, logger="codify.inner.codex_executor")

...
from codify import opencode_http_transport as transport_mod
from codify.inner.executor import ExecutorError, TurnComplete
from codify.inner.opencode_native_executor import OpenCodeNativeExecutor
...
def test_harness_create_app_builds_fastapi() -> None:
    ...
    from codify.inner.opencode_native_harness import create_app
...
def test_harness_executor_factory_builds_from_env(
    ...
    from codify.inner.opencode_native_harness import _build_opencode_native_executor
    from codify.opencode_native_bridge import OPENCODE_NATIVE_BRIDGE_DIR_ENV_VAR

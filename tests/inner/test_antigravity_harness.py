...
from codify.inner import antigravity_harness
...
def test_harness_module_registered_in_module_registry() -> None:
    ...
    spec.
    """
    assert _HARNESS_MODULES.get("antigravity") == "codify.inner.antigravity_harness"
...
def _capture_factory_kwargs(monkeypatch: pytest.MonkeyPatch) -> dict[str, Any]:
    ...
    monkeypatch.setattr(
        "codify.inner.antigravity_harness.AntigravityExecutor.__init__", _fake_init
    )

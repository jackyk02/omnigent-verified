...
@pytest.mark.parametrize(
    "line",
    [
        'patch("codify.tools.mcp.asyncio.sleep")',
        'mock.patch("codify.tools.mcp.asyncio.sleep", new_callable=AsyncMock)',
        'monkeypatch.setattr("codify.llms.client.asyncio.sleep", _fake)',
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'patch("codify.tools.mcp._sleep", new_callable=AsyncMock)',
...
def test_main_exit_codes(tmp_path: Path) -> None:
    ...
    dirty.write_text('patch("codify.x.asyncio.sleep")\n')
    clean = tmp_path / "test_clean.py"
    clean.write_text('patch("codify.x._sleep")\n')

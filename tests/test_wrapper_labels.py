...
import them from :mod:`codify._wrapper_labels`, and the server's
...
def test_claude_native_wrapper_constants_match_claude_native_module() -> None:
    """
    ``codify.claude_native`` imports the same key/value pair.
...
def test_claude_native_wrapper_constants_match_chat_module() -> None:
    """
    ``codify.chat`` imports the same key/value pair.
    ...
    drift here would mean ``codify attach <claude-id>``
    silently opens an Codify REPL on top of a tmux session it can't see —
...
def test_claude_native_wrapper_constants_match_picker_module() -> None:
    """
    ``codify.repl._resume_picker`` imports the same key/value pair.
    ...
    symptom.
    """
    from codify.repl import _resume_picker
...
def test_claude_native_wrapper_constants_match_server_routes() -> None:
    """
    ``codify.server.routes.sessions`` carries its own copy of the
...
def test_codex_native_wrapper_constants_match_codex_native_module() -> None:
    """
    ``codify.codex_native`` imports the same key/value pair.
...
def test_codex_native_wrapper_constants_match_picker_module() -> None:
    """
    ``codify.repl._resume_picker`` imports the Codex wrapper value.
...
def test_pi_native_wrapper_constants_match_pi_native_module() -> None:
    """``codify.pi_native`` imports the same key/value pair."""
    from codify import pi_native
...
def test_pi_native_wrapper_constants_match_registry() -> None:
    ...
    from codify.harness_plugins import PI_NATIVE_CODING_AGENT
...
def test_kiro_native_wrapper_constants_match_registry() -> None:
    ...
    from codify.harness_plugins import KIRO_NATIVE_CODING_AGENT

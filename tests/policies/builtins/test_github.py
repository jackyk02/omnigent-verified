...
(:mod:`codify.policies.builtins.github`) — the single ``github_policy``
...
from codify.policies.builtins.github import github_policy
...
_HANDLER = "codify.policies.builtins.github.github_policy"
_REPO = "octo/hello"

...
(:mod:`codify.policies.builtins.risk_score`) — the single configurable
...
from codify.policies.builtins.risk_score import (
...
_HANDLER = "codify.policies.builtins.risk_score.risk_score_policy"

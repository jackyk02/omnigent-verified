...
from codify.errors import _CODE_TO_HTTP_STATUS, CodifyError, ErrorCode
...
def test_codify_error_with_harness_violation_code_returns_500() -> None:
    """End-to-end: CodifyError(code=HARNESS_PROTOCOL_VIOLATION).http_status == 500.
...
def test_all_error_codes_have_http_status_mapping(code: str, expected_status: int) -> None:
    ...
    CodifyError.http_status — not wrong, but it hides drift.

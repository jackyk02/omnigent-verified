"""Tests for the ``codify usage`` command and its renderer."""
...
from codify.cli import _render_usage, cli
...
def _stub_usage_fetch(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("codify.cli._resolve_attach_server", lambda *a, **k: "http://x")
    monkeypatch.setattr("codify.chat._remote_headers", lambda **k: {})

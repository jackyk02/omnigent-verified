...
from codify import qwen_native_bridge as qnb
from codify import qwen_native_forwarder as fwd
...
def test_qwen_session_recording_exists_is_workspace_scoped(
    ...
    from codify.qwen_native_bridge import _qwen_project_slug
...
def test_qwen_session_recording_path_is_workspace_scoped(
    ...
    from codify.qwen_native_bridge import _qwen_project_slug, qwen_session_recording_path
...
def test_harness_registered_aliased_and_native() -> None:
    from codify.harness_aliases import canonicalize_harness, is_native_harness
    ...
    assert _HARNESS_MODULES["qwen-native"] == "codify.inner.qwen_native_harness"
    # Allowlisted + recognized as a native-terminal harness (both spellings).
    assert "qwen-native" in CODIFY_HARNESSES
...
def test_harness_create_app_builds() -> None:
    from codify.inner.qwen_native_harness import create_app

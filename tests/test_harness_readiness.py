"""Tests for codify.onboarding.harness_readiness gating."""

from __future__ import annotations

import pytest

from codify.onboarding import harness_readiness as hr
...
def test_configured_harness_map_pi_installed_no_provider_needs_auth(
    ...
    Pi has no CLI login — its only credential is an codify-managed provider —

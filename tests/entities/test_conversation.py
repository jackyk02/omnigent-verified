...
@pytest.mark.parametrize(
    ...
    [
            ...
            [
                {
                    "type": "input_text",
                    "text": (
                        "[Attached: /tmp/codify/claude-native/0a1b/uploads/shot.png]"
                        "\n\nfix this layout bug"
                    ),
                }
            ],
        ...
        (
            [
                {"type": "input_text", "text": "[Attached file: /tmp/codify/u/report.bin]"},
        ...
        (
            [{"type": "input_text", "text": "[Attached: /tmp/codify/u/img.png]"}],
            None,
        ),

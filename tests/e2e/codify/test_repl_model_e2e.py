"""E2E: /model command in the Codify REPL under pexpect.

Migrated to mock LLM: drives ``/model`` against a mock ``codify run``
...
def test_repl_model_command_show_set_reset(
    ...
    try:
        ...
        # _build_model_readout_lines in codify/repl/_repl.py). With no

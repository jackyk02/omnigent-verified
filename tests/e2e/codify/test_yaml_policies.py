...
- Codify' policy engine regresses.
...
def test_yaml_policies_blocks_canada_input(
    ...
    """
    ``codify run agent_with_policies.yaml --harness <harness>
    ...
    yaml_path = codify_repo_root / "tests" / "resources" / "examples" / "agent_with_policies.yaml"

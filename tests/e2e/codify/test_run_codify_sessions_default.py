"""End-to-end: ``codify run`` renders through sessions (mock LLM).
...
from tests.e2e.codify._pexpect_harness import ensure_repl_test_theme_env, submit_prompt
...
def test_repl_default_sessions_renders_assistant_text(
    ...
    """``codify run`` renders assistant text through sessions.

...
``codify/runner/uc_function.py`` — metadata fetch at agent-build
...
from tests.e2e.codify._example_helpers import validate_agent_def_structure
...
def test_agent_with_uc_tools_structure(
    ...
    :param codify_repo_root: Repo root for subprocess cwd so

"""Unit tests for codify-style in-process callable tools."""
...
from codify.tools.local_callable import LocalCallableTool, load_local_callable_tools

_TEST_CTX = ToolContext(task_id="task_test", agent_id="agent_test")
_CALLABLE_LANGUAGE = "codify-python-callable"
...
def test_load_local_callable_tools_filters_to_codify_server_callables() -> None:

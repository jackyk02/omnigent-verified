...
def test_unknown_wrapper_session_does_not_use_native_bypass() -> None:
    ...
    bypass, otherwise Codify would skip persistence for regular sessions.
    """
    from codify.server.routes import sessions as sessions_routes
...
def test_custom_native_harness_session_without_wrapper_label_is_native(
    ...
    ``codify.wrapper`` label — it renders chat-first on purpose. Its runner

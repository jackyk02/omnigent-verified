...
from codify.codex_native_state import (
    read_launch_state,
    write_launch_state,
)
...
def test_write_and_read_launch_state_round_trips(
    ...
    monkeypatch.setenv("CODIFY_CODEX_NATIVE_STATE_DIR", str(state_root))
...
def test_conflicting_launch_state_write_keeps_original(
    ...
    # warning is emitted by ``codify.codex_native_state`` and

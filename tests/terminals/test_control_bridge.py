"""
Unit + integration tests for :mod:`codify.terminals.control_bridge`.
...
from codify.terminals.control_bridge import (
...
async def test_seed_restores_cursor_position() -> None:
    ...
    """
    from codify.terminals.control_bridge import _run_tmux_capture

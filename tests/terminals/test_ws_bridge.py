"""
Unit tests for :mod:`codify.terminals.ws_bridge`.
...
import codify.terminals.ws_bridge as ws_bridge
...
def test_current_coalesce_limit_static_value() -> None:
    ...
    given a static cap.
    """
    from codify.terminals.ws_bridge import _current_coalesce_limit
...
def test_coalesce_limit_after_input_returns_large_cap_with_no_input() -> None:
    ...
    """
    from codify.terminals.ws_bridge import _coalesce_limit_after_input
...
def test_monotonic_returns_float() -> None:
    ...
    """
    from codify.terminals.ws_bridge import _monotonic

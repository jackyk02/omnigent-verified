...
def test_linkify_pr_refs() -> None:
    out = mod.linkify_pr_refs("fixed in #1304 and #20", "codify-ai/codify")
    assert "[#1304](https://github.com/codify-ai/codify/pull/1304)" in out
    assert "[#20](https://github.com/codify-ai/codify/pull/20)" in out
...
def test_release_body_to_mdx_structure() -> None:
    ...
    page = mod.release_body_to_mdx("v0.3.0", "2026-06-27", body, "codify-ai/codify")

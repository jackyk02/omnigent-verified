...
from the Codify server survive. A future refactor that swaps ``+`` for
...
from codify.runner.app import _inject_mcp_schemas
...
def test_inject_appends_after_existing_tools() -> None:
    """MCP schemas land AFTER the Codify server's tools, in order.

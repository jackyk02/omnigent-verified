...
from codify.runner.tool_dispatch import _execute_policy_tool
...
async def test_add_policy_cel() -> None:
    ...
    assert body["handler"] == "codify.policies.builtins.cel.cel_policy"
...
async def test_add_policy_builtin() -> None:
    ...
    assert body["handler"] == "codify.policies.builtins.safety.max_tool_calls_per_session"
...
async def test_policy_registry_returns_entries() -> None:
    ...
    assert parsed["policies"][0]["handler"] == "codify.policies.builtins.cel.cel_policy"

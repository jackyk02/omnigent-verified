"""Tests for ``_evaluate_policy_via_codify`` fail-open / fail-closed.

The runner proxies harness policy-evaluation requests to the Codify
...
from codify.runner.app import _evaluate_policy_via_codify
...
async def _run(server_client: Any, phase: str) -> dict[str, Any]:
    ...
    :param server_client: Stub Codify-server client.
    ...
    await _evaluate_policy_via_codify(

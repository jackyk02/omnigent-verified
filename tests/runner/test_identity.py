...
def test_importing_identity_does_not_pull_in_fastapi() -> None:
    """``import codify.runner.identity`` stays free of the FastAPI stack.
    ...
    ``from codify.runner.app import create_runner_app`` in the package
    ``__init__``, this fails.

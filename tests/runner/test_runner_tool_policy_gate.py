...
_BROKEN_PATH = "codify.nonexistent_module.broken_policy"
...
_RAISING_PATH = "codify.policies.function.make_fixed_action_callable"
...
async def test_resolve_diagnostic_omits_exception_message_secrets() -> None:
    ...
    import codify.runner.policy as policy_mod

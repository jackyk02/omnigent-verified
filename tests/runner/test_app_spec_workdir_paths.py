...
"codify-python-callable"``) store a DOTTED IMPORT PATH in the same
...
from codify.runner.app import _spec_with_workdir_paths
from codify.spec.types import AgentSpec, LocalToolInfo
...
@pytest.mark.parametrize("language", ["codify-python-callable", "python", None])

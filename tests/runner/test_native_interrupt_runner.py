...
async def test_uniform_interrupt_injects_and_wakes_parent(
    ...
    import codify.goose_native_bridge as goose_bridge
...
async def test_uniform_interrupt_bridge_error_returns_503(
    ...
    import codify.qwen_native_bridge as qwen_bridge
...
async def test_uniform_stop_kills_tears_down_and_goes_idle(
    ...
    import codify.cursor_native_bridge as cursor_bridge
...
async def test_uniform_stop_kill_failure_returns_503_without_idle(
    ...
    import codify.hermes_native_bridge as hermes_bridge
...
async def test_claude_interrupt_resolves_bridge_id_and_injects(
    ...
    import codify.claude_native_bridge as claude_bridge
    from codify.runner.native import interrupt as interrupt_mod

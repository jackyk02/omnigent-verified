...
from codify.spec.types import AgentSpec, ExecutorSpec, MCPServerConfig
...
class _ReadTimeoutTransport(httpx.AsyncBaseTransport):
    ...
    async def handle_async_request(self, request: httpx.Request) -> httpx.Response:
        ...
        :raises httpx.ReadTimeout: Always raised to simulate Codify slowness.
        """
...
def _no_wake_backoff(monkeypatch: pytest.MonkeyPatch) -> list[float]:
    ...
    monkeypatch.setattr("codify.runner.app._wake_retry_sleep", _record)
    return recorded

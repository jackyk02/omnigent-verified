...
def test_create_tool_schema_makes_workspace_and_host_optional() -> None:
    from codify.tools.builtins.scheduled_tasks import SysScheduledTaskCreateTool
...
def test_update_tool_schema_allows_connected_host_changes() -> None:
    from codify.tools.builtins.scheduled_tasks import SysScheduledTaskUpdateTool

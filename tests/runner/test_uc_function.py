"""Unit tests for :mod:`codify.runner.uc_function`.
...
from codify.runner.uc_function import (
    _build_select_statement,
)
...
async def test_execute_uc_function_warehouse_from_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "codify.runner.uc_function._get_workspace_client",
...
def test_is_uc_function_tool_true() -> None:
    ...
    from codify.runner.tool_dispatch import _is_uc_function_tool
...
def test_resolve_uc_profile_from_auth() -> None:
    ...
    from codify.runner.tool_dispatch import _resolve_uc_profile

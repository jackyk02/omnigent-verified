"""E2E: Monaco file surfaces follow Codify's theme, not the OS scheme."""
...
def test_file_editor_uses_explicit_codify_theme(
    page: Page, seeded_python: tuple[str, str]
) -> None:
    """A light Codify palette overrides a dark system for Monaco surfaces."""
    page.emulate_media(color_scheme="dark")
    page.add_init_script(
        """
        localStorage.setItem("web-theme", "light");
        localStorage.setItem("codify:ui-theme-palette", JSON.stringify("gruvbox"));
        """
    )

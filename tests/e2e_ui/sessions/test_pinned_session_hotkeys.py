...
``window.codifyDesktop.kind === "electron"`` — see
...
exercise it end-to-end we inject a minimal ``window.codifyDesktop`` stub
...
# `window.codifyDesktop?.kind === "electron"`) sees a native shell. Every

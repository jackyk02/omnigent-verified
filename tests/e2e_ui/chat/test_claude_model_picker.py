...
from codify.claude_native import ClaudeNativeUcodeConfig, claude_native_model_options
...
def test_claude_native_picker_updates_after_delayed_catalog(
    ...
    page.add_init_script("window.localStorage.setItem('codify.picker.model', 'opus')")
...
def test_claude_native_picker_prefers_session_override_over_sticky_model(
    ...
    page.add_init_script("window.localStorage.setItem('codify.picker.model', 'haiku')")
    base_url, session_id = seeded_session

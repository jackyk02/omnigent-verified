...
pytestmark = pytest.mark.skipif(
    not os.environ.get("CODIFY_E2E_SWITCH_AGENT_UI"),
    reason="Switch-agent has no UI entry point (header button removed); "
    "set CODIFY_E2E_SWITCH_AGENT_UI=1 once the affordance returns.",
)
...
def _builtin_agent_id(base_url: str, name: str) -> str:
    ...
    pytest.fail(
        ...
        f"live_server seeds it via CODIFY_BUILTIN_AGENT_DIRS; an external "

...
(:mod:`codify.kiro_native_session_forwarder`) tails Kiro's structured session
...
:class:`codify.inner.kiro_native_executor.KiroNativeExecutor`. This suite is the
...
def _kiro_unavailable_reason() -> str | None:
    ...
    Codify-managed credential). CI provisions no Kiro account, so any missing

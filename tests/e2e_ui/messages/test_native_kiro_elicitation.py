...
pytestmark = pytest.mark.skipif(
    os.environ.get("CODIFY_E2E_KIRO_NATIVE") != "1" or _KIRO_SKIP_REASON is not None,
    reason=(
        _KIRO_SKIP_REASON
        or "native Kiro approval e2e needs an interactive Kiro login; set CODIFY_E2E_KIRO_NATIVE=1"
    ),
)

...
import codify.antigravity_native_launch as _mod
...
class TestResolveNativeAntigravityLaunch:
    ...
    def test_returns_subscription_when_credential_present(
        ...
        monkeypatch.setattr(
            "codify.antigravity_native_launch.gemini_auth_has_credential",
            lambda: True,
        )
    ...
    def test_warns_when_no_credential(
        ...
        with caplog.at_level(logging.WARNING, logger="codify.antigravity_native_launch"):
            resolve_native_antigravity_launch()

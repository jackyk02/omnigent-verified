"""Unit tests for :class:`codify.opencode_http_transport.OpenCodeHttpTransport`.
...
from codify.opencode_http_transport import OpenCodeHttpTransport, build_prompt_payload
...
def _launch(**kwargs: Any) -> NativeLaunchConfig:
    return NativeLaunchConfig(codify_session_id="conv_1", workspace="/w", **kwargs)

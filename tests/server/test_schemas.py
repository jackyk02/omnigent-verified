...
The event models live in :mod:`codify.server.schemas`;
this module only references the request/response schemas in
:mod:`codify.server.schemas` for the embedded ``ResponseObject``.
"""
...
def test_elicitation_request_params_preserves_unknown_fields() -> None:
    ...
    elicitation/create call traversing harness → Codify → client doesn't
...
def test_session_create_git_requires_host_id() -> None:
    ...
    """
    from codify.server.schemas import SessionCreateRequest, SessionGitOptions
...
def test_session_create_host_type_defaults_external() -> None:
    ...
    """
    from codify.server.schemas import SessionCreateRequest
...
def test_session_response_status_accepts_canonical_set(status: str) -> None:
    ...
    """
    from codify.server.schemas import SessionResponse
...
def test_session_list_item_status_accepts_canonical_set(status: str) -> None:
    ...
    from codify.server.schemas import SessionListItem

...
Tests :func:`codify.server.permissions.check_session_access` and
:func:`codify.server.permissions.check_is_manager` against all
resolution branches:
...
def test_header_mode_rejects_missing_header(
    ...
    explicit single-user local runtimes (CODIFY_LOCAL_SINGLE_USER=1).
    """

...
from codify.entities import Conversation, ResolvedAccess, SessionPermission
from codify.errors import CodifyError
from codify.runtime import _globals, set_runner_client, set_runner_router
...
def app(runner_globals_reset: None, runner_client: _RecordingRunnerClient) -> FastAPI:
    ...
    @application.exception_handler(CodifyError)
    ...
    application.include_router(
        create_sessions_router(
            ...
            # set in tests/conftest.py (CODIFY_LOCAL_SINGLE_USER=1).

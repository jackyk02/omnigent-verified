...
:func:`codify.server.routes.sessions.configure_subagent_block_notifier`
plus the ``_wake_parent_for_blocked_child`` delivery it wires — driven
through the real
:func:`codify.runtime.pending_elicitations.record_publish` chokepoint
...
async def _instant_sleep(_seconds: float) -> None:
    ...
    Patched over :func:`codify.runtime.subagent_block_notifier._sleep`

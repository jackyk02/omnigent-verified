...
from codify.entities import Conversation, SessionPermission
...
def server_registry(tmp_path: Path) -> Iterator[TerminalRegistry]:
    ...
    The route reads via :func:`codify.runtime.get_terminal_registry`,
...
async def test_attach_terminal_local_fallback_spawns_tmux(
    ...
    monkeypatch.setattr("codify.terminals.ws_bridge.os.execve", fake_execve)
    monkeypatch.setattr(
        "codify.terminals.ws_bridge.os._exit",

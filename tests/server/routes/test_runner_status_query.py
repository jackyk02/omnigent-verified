...
from codify.server.routes.sessions import _query_host_runner_status
...
async def test_query_times_out_to_none(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    monkeypatch.setattr("codify.server.routes.sessions._HOST_RUNNER_STATUS_TIMEOUT_S", 0.05)
    conn = _FakeHostConn()

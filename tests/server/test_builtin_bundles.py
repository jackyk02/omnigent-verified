"""Tests for the built-in agent bundle builders in ``codify/server/app.py``.
...
from codify.native_coding_agents import NATIVE_CODING_AGENTS as _NATIVE_CODING_AGENTS
from codify.server import app
...
# caught here. See codify.spec.load(..., prune_invalid_sub_agents=True).

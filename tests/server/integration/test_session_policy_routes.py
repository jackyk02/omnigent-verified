...
async def test_create_policy(
    ...
    assert body["handler"] == "codify.policies.builtins.safety.ask_on_os_tools"
...
async def test_update_policy(
    ...
    resp = await auth_client.patch(
        f"/v1/sessions/{session_id}/policies/{policy_id}",
        json={"enabled": False, "handler": "codify.policies.builtins.safety.block_skills"},
        headers=headers,
    )
    resp.raise_for_status()
    body = resp.json()
    ...
    assert body["handler"] == "codify.policies.builtins.safety.block_skills"

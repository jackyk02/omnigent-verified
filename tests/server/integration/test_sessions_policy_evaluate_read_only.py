...
from codify.server.auth import LEVEL_EDIT, LEVEL_READ
from codify.spec.types import FunctionPolicySpec, FunctionRef, Phase
...
async def test_request_phase_ask_parks_server_side_and_collapses_to_allow(
    ...
    monkeypatch.setattr(
        "codify.server.routes.sessions._hold_native_ask_gate",
        _fake_hold,
    )

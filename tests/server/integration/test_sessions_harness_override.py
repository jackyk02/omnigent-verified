...
async def test_create_rejects_harness_override_for_non_codify_agent(
    client: httpx.AsyncClient,
) -> None:
    """Non-codify executor types reject the override instead of no-opping.
    ...
    agent = await create_test_agent(
        ...
        # A non-codify executor type (claude_sdk rejects the helper's

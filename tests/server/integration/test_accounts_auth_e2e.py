...
def _build_app(
    ...
    *,
    ...
    monkeypatch.setenv("CODIFY_ACCOUNTS_COOKIE_SECRET", _COOKIE_SECRET_HEX)
    ...
    monkeypatch.setenv("CODIFY_ACCOUNTS_INIT_ADMIN_USERNAME", _ADMIN_USERNAME)
...
async def client(accounts_app: FastAPI) -> AsyncIterator[httpx.AsyncClient]:
    ...
    from codify.db.utils import clear_engine_cache

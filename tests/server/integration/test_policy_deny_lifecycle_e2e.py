...
async def policy_client(
    ...
    policy_store = SqlAlchemyPolicyStore(db_uri)
    monkeypatch.setattr("codify.runtime._globals._policy_store", policy_store)
    ...
    from codify.server.routes import session_policies as _sp_mod
    ...
    monkeypatch.setattr(
        ...
        lambda handler: (
            handler == "codify.policies.function.make_fixed_action_callable"

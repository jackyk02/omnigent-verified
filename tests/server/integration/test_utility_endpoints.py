...
async def test_info_returns_expected_fields(client: httpx.AsyncClient) -> None:
    ...
    # CODIFY_HARNESS_INSTALL_ENABLED is set, so it's false in the test app.
    ...
    # single_user reflects CODIFY_LOCAL_SINGLE_USER, which the suite's
...
async def test_info_single_user_false_without_marker(
    ...
    """``single_user`` tracks ``CODIFY_LOCAL_SINGLE_USER`` live.

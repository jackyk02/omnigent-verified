...
from codify.server.routes._auth_helpers import attribution_user
from codify.server.routes.sessions import _build_new_item
...
async def test_post_event_uses_runner_supplied_created_by(
    ...
    from codify.server.routes import sessions as sessions_mod
    from codify.server.routes.sessions import routes_events as events_mod

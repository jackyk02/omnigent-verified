"""Tests for the scheduled-task fire path (:mod:`codify.server.scheduled.fire`).
...
from codify.entities import ScheduledTask
from codify.server.auth import LEVEL_OWNER, RESERVED_USER_LOCAL
from codify.server.scheduled import fire as fire_mod
...
async def test_connected_host_dispatch_uses_resolved_local_owner(
    ...
    import codify.server.routes._host_launch as host_launch
...
async def test_resolve_default_workspace_returns_canonical_path(
    ...
    import codify.server.routes._workspace_validation as wsv

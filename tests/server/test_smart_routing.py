...
from codify.server.smart_routing import (
...
@dataclass
class _FakeResponse:
    """Minimal stub matching codify.llms.types.Response."""
...
def test_router_error_detail_unwraps_nested_message() -> None:
    from codify.server.smart_routing import _router_error_detail

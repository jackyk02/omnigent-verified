"""Tests for mirroring Kiro's persisted CLI session into Codify."""
...
import codify.kiro_native_session_forwarder as forwarder
...
async def test_forward_kiro_session_posts_conversation_messages(
    ...
    with pytest.raises(asyncio.CancelledError):
        await forwarder.forward_kiro_session_to_codify(

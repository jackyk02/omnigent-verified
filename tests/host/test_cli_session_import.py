"""Unit tests for ``codify session import``."""
...
from codify.cli import _import_item_payload, cli
...
def _patch_server(base_url: str = _BASE) -> Any:
    ...
    return patch("codify.cli._resolve_attach_server", return_value=base_url)

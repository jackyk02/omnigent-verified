...
def test_env_override_returns_identity_without_touching_config(
    ...
    """
    monkeypatch.setenv("CODIFY_HOST_ID", "329c39d03aad39ccf2f8597d596676bd")
    monkeypatch.setenv("CODIFY_HOST_NAME", "managed-env")
    config_path = tmp_path / "config.yaml"
...
def test_env_override_requires_both_vars(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    monkeypatch.setenv("CODIFY_HOST_ID", "329c39d03aad39ccf2f8597d596676bd")
    monkeypatch.delenv("CODIFY_HOST_NAME", raising=False)

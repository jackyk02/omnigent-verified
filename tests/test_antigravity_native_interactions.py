...
These exercise :func:`codify.antigravity_native_interactions.bridge_interaction`
...
from codify.antigravity_native_interactions import (
    _freshest_waiting,
    agy_elicitation_id,
    bridge_interaction,
)
...
def _question_step(
    *, step_index: int, status: str = "CORTEX_STEP_STATUS_WAITING"
    ...
    :func:`codify.antigravity_native_steps.pending_interaction`:
...
def test_tui_injector_for_binds_an_explicit_bridge_dir(
    ...
    from codify.antigravity_native_interactions import tui_injector_for

...
import codify.claude_native_state as claude_state
import codify.codex_native_state as codex_state
import codify.opencode_native_state as opencode_state

_HEX = "12dcd7df501e40e9a506a5b0058cbafc"

_MODULES = [
    pytest.param(claude_state, "CODIFY_CLAUDE_NATIVE_STATE_DIR", id="claude"),
    pytest.param(codex_state, "CODIFY_CODEX_NATIVE_STATE_DIR", id="codex"),
    pytest.param(opencode_state, "CODIFY_OPENCODE_NATIVE_STATE_DIR", id="opencode"),
]

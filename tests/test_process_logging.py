...
def test_terminal_log_formatter_abbreviates_warning_and_source() -> None:
    ...
    record = logging.LogRecord(
        "codify.codex_native_app_server",
        logging.WARNING,
        __file__,
        1,
        "native-codex: ready",
    ...
    assert "codify.codex_native_app_server" not in output
...
def test_terminal_supports_color_no_color_overrides_ambient_force(
    ...
    """NO_COLOR disables ambient force-color hints, but not Codify-owned mirrors."""

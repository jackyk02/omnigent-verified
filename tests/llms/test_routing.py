...
from codify.llms.routing import RoutedModel, infer_harness_from_model, parse_model_string
...
def test_unknown_provider_raises() -> None:
    with pytest.raises(CodifyError, match="Unknown provider 'foobar'"):
...
def test_infer_harness_from_model(model: str, expected_harness: str) -> None:
    ...
    assert infer_harness_from_model(model) == expected_harness, (
        ...
        "Check _HARNESS_FOR_MODEL_PREFIX in codify/llms/routing.py."
    )

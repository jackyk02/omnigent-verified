"""Unit tests for :mod:`codify.llms._usage_observer`.

Covers the observer registry contract (add/remove/exception-isolation)
and the auto-recorder that activates when ``CODIFY_TOKEN_USAGE_JSON``
is set.
"""
...
async def test_client_notify_records_with_active_test(
    ...
    from codify.llms.client import Client, _ResponsesNamespace
    from codify.llms.types import MessageOutput, OutputText, Response, Usage

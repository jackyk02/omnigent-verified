...
from codify.llms.adapters.openai import (
    OpenAIAdapter,
    OpenAICompatibleAdapter,
    _parse_sse_line,
)
from codify.llms.types import ResponseTextDeltaEvent
...
def test_resolve_base_url_override_wins() -> None:
    from codify.llms.adapters.openai import _resolve_base_url
...
def test_resolve_base_url_raises_when_both_none() -> None:
    ...
    with pytest.raises(CodifyError, match="base_url"):
...
def test_to_responses_tools_flattens_chat_format() -> None:
    from codify.llms.adapters.openai import _to_responses_tools
...
def test_parse_responses_output_message() -> None:
    from codify.llms.adapters.openai import _parse_responses_output
    from codify.llms.types import MessageOutput
...
def test_parse_responses_output_function_call() -> None:
    from codify.llms.adapters.openai import _parse_responses_output
    from codify.llms.types import FunctionCallOutput
...
def test_parse_responses_output_native_tool() -> None:
    from codify.llms.adapters.openai import _parse_responses_output
    from codify.llms.types import NativeToolOutput
...
def test_parse_responses_response_full() -> None:
    from codify.llms.adapters.openai import _parse_responses_response
    from codify.llms.types import MessageOutput, Usage
...
def test_parse_responses_response_missing_model_raises() -> None:
    ...
    with pytest.raises(CodifyError, match="model"):
...
def test_parse_responses_event_text_delta() -> None:
    from codify.llms.adapters.openai import _parse_responses_event
    from codify.llms.types import ResponseTextDeltaEvent
...
def test_parse_responses_event_reasoning_delta() -> None:
    from codify.llms.adapters.openai import _parse_responses_event
    from codify.llms.types import ResponseReasoningTextDeltaEvent
...
def test_parse_responses_event_reasoning_summary_delta() -> None:
    from codify.llms.adapters.openai import _parse_responses_event
    from codify.llms.types import ResponseReasoningSummaryTextDeltaEvent
...
def test_parse_responses_event_reasoning_started() -> None:
    from codify.llms.adapters.openai import _parse_responses_event
    from codify.llms.types import ResponseReasoningStartedEvent
...
def test_parse_responses_event_native_tool_done() -> None:
    from codify.llms.adapters.openai import _parse_responses_event
    from codify.llms.types import NativeToolOutputAddedEvent
...
def test_parse_responses_event_completed() -> None:
    from codify.llms.adapters.openai import _parse_responses_event
    from codify.llms.types import ResponseCompletedEvent
...
def test_streamed_400_overflow_classified_as_context_window_exceeded(
    ...
    from codify.llms.errors import ContextWindowExceededError
    from codify.runtime.llm_retry import classify_llm_error

...
from codify.llms._responses_to_chat import chat_stream_to_response_events
from codify.llms.adapters.gemini import (
    GeminiAdapter,
    _chat_to_gemini,
    _convert_tools,
    _extract_usage,
...
def test_gemini_stream_text_chunk() -> None:
    ...
    from codify.llms.adapters.gemini import _gemini_stream_chunk_to_chat
...
def test_empty_chat_response_structure() -> None:
    ...
    from codify.llms.adapters.gemini import _empty_chat_response
...
def test_none_content_becomes_empty_parts() -> None:
    ...
    from codify.llms.adapters.gemini import _content_to_gemini_parts
...
async def test_get_headers_with_api_key() -> None:
    ...
    from codify.llms.adapters.gemini import GeminiAdapter

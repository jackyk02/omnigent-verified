"""Tests for codify.onboarding.provider_selection — selection logic."""
...
from codify.onboarding.provider_selection import (
    ProviderSelection,
...
def test_resolve_reads_api_key_from_codify_prefixed_env(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """Non-interactive provider selection accepts ``CODIFY_`` key aliases."""
    monkeypatch.delenv("ANTHROPIC_API_KEY", raising=False)
    monkeypatch.setenv("CODIFY_ANTHROPIC_API_KEY", "sk-prefixed")

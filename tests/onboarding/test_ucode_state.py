"""Unit tests for codify.onboarding.ucode_state."""
...
from codify.onboarding.ucode_state import (
    UcodeWorkspaceState,
...
def test_read_ucode_state_returns_state_when_configured(tmp_path: Path) -> None:
    ...
    with patch("codify.onboarding.ucode_state._STATE_PATH", state_file):
...
def test_read_ucode_state_returns_none_when_file_absent(tmp_path: Path) -> None:
    ...
    with patch("codify.onboarding.ucode_state._STATE_PATH", tmp_path / "nonexistent.json"):

"""Unit tests for codify.onboarding.databricks_config."""
...
def test_get_workspace_url_for_profile_reads_databrickscfg(tmp_path: Path) -> None:
    ...
    with patch("codify.onboarding.databricks_config._DATABRICKSCFG_PATH", cfg_path):
...
def test_get_workspace_url_for_profile_returns_none_when_file_absent(
    ...
    with patch(
        "codify.onboarding.databricks_config._DATABRICKSCFG_PATH",

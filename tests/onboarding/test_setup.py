"""Tests for :mod:`codify.onboarding.setup`.

Cover the onboarding helpers used by ``codify setup``: env-var hygiene
...
from codify.onboarding import setup as setup_mod
from codify.onboarding.setup import (
...
def test_maybe_run_skips_when_skip_env_set(monkeypatch: pytest.MonkeyPatch) -> None:
    """``CODIFY_SKIP_ONBOARD=1`` short-circuits before any side effects."""

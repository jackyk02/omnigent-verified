"""Tests for :mod:`codify.onboarding.sandboxes.boxlite`."""
...
from codify.onboarding.sandboxes import boxlite as blmod
from codify.onboarding.sandboxes.base import (
    DEFAULT_HOST_IMAGE,
    SandboxCapabilityError,
)
from codify.onboarding.sandboxes.boxlite import (
    HOST_IMAGE_ENV_VAR,
...
def test_prepare_local_requires_kvm_on_linux(
    ...
    monkeypatch.setattr("codify.onboarding.sandboxes.boxlite.platform.system", lambda: "Linux")
...
def test_prepare_local_passes_on_macos(
    ...
    monkeypatch.setattr("codify.onboarding.sandboxes.boxlite.platform.system", lambda: "Darwin")
    BoxliteSandboxLauncher().prepare()

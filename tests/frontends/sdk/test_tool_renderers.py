...
import pytest
from codify_client import NativeToolBlock, ToolExecution
from codify_ui_sdk.terminal._tool_renderers import (
...
def test_formatter_uses_specialized_tool_renderer() -> None:
    ...
    from codify_client._blocks import ToolGroup
    from codify_ui_sdk.terminal._formatter import RichBlockFormatter
...
def test_formatter_result_block_preserves_arguments_for_edit_diff() -> None:
    ...
    from codify_client._blocks import ToolResultBlock
    from codify_ui_sdk.terminal._formatter import RichBlockFormatter
...
def test_formatter_native_tool_specialized() -> None:
    ...
    from codify_client._blocks import NativeToolBlock
    from codify_ui_sdk.terminal._formatter import RichBlockFormatter

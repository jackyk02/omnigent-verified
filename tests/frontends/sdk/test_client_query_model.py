"""Unit test: ``CodifyClient.query(..., model_override=...)`` threads to Session.
...
import pytest
from codify_client._client import CodifyClient
...
async def test_client_query_threads_model_override_to_temporary_session(
    ...
    class _FakeSession:
        ...
        access fails loudly — see ``.claude/skills/codify-testing``
        rule 3.
        """
    ...
    client = CodifyClient("http://example.invalid")

...
import pytest
from codify_client._events import ResponseCompleted, ResponseCreated
from codify_client._session import Session
from codify_client._types import Response
...
class _ResponsesStub:
    ...
    ``.claude/skills/codify-testing/SKILL.md`` rule 3.
    """
...
class _ClientStub:
    """Stand-in for :class:`CodifyClient` exposing only ``responses``."""

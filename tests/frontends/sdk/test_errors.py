...
import httpx
import pytest
from codify_client._errors import CodifyError, require_json_object, response_body
...
def test_require_json_object_rejects_html_success_response() -> None:
    """Successful HTML fallback pages raise ``CodifyError`` with context."""
    resp = httpx.Response(
        200,
        headers={"content-type": "text/html; charset=utf-8"},
        text="<!doctype html><title>Codify</title>",
    )

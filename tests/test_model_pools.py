...
_SPREAD_ENV = "CODIFY_TEST_MODEL_SPREAD"
...
def test_env_override_replaces_pool(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv(_SPREAD_ENV, "1")
    monkeypatch.setenv("CODIFY_TEST_MODEL_POOL_GPT", "databricks-gpt-9-test")
...
def test_drained_model_kept_when_it_is_the_pinned_base(
    ...
    monkeypatch.setenv(_SPREAD_ENV, "1")
    monkeypatch.setenv("CODIFY_TEST_MODEL_POOL_GPT", "databricks-gpt-5-5")

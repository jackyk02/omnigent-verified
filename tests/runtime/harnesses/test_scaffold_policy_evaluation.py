...
from codify.runtime.harnesses._scaffold import (
    PolicyVerdictEvent,
...
async def test_evaluate_policy_round_trip(_turn_ctx: TurnContext) -> None:
    ...
    # so the runner can route the request to the Codify server.
...
async def test_evaluate_policy_timeout_returns_allow(
    ...
    import codify.runtime.harnesses._scaffold as _scaffold_mod

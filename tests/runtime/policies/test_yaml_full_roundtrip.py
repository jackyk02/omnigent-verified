...
from codify.runtime.policies import build_policy_engine
from codify.runtime.policies.engine import PolicyEngine
from codify.spec.parser import parse
...
""",
    ...
    assert check_spec.function.path == "codify.policies.builtins.prompt.prompt_policy"
...
async def test_yaml_on_key_stays_string(
    ...
    Codify' custom loader keeps it as a string. If
...
""",
    ...
    assert prompt_spec.function.path == "codify.policies.builtins.prompt.prompt_policy"

...
from codify.policies.builtins.cost import user_daily_cost_budget
from codify.policies.function import FunctionPolicy
from codify.policies.schema import USER_DAILY_ASK_APPROVED_STATE_KEY
...
async def test_approval_updates_in_memory_so_same_engine_does_not_reask(
    ...
    policy = FunctionPolicy(
        FunctionPolicySpec(
            ...
            function=FunctionRef(path="codify.policies.builtins.cost.user_daily_cost_budget"),
        ),

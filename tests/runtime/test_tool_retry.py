...
from codify.runtime.tool_retry import (
    call_tool_with_timeout,
    execute_tool_with_retry,
    resolve_tool_retry,
    resolve_tool_timeout,
)
from codify.spec.types import RetryPolicy, ToolsConfig
...
def test_execute_tool_with_retry_retries_on_timeout(
    ...
    monkeypatch.setattr("codify.runtime.tool_retry.time.sleep", lambda _: None)
    ...
    monkeypatch.setattr(
        "codify.runtime.tool_retry.call_tool_with_timeout",
...
def test_tool_retry_event_has_correct_fields(
    ...
    # ``codify.spec.types``) and uses a function-local
    # ``import random`` — patching either
    # ``codify.runtime.tool_retry.random`` or
    # ``codify.spec.types.random`` won't catch the local

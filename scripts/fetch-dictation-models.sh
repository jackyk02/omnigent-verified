...
# (designs/server-dictation.md) into ~/.codify/models/dictation/:
...
# point CODIFY_DICTATION_MODEL_DIR / CODIFY_DICTATION_PUNCT_DIR at
# alternates.
set -euo pipefail

DEST="${CODIFY_DICTATION_MODEL_ROOT:-$HOME/.codify/models/dictation}"

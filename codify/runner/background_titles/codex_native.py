...
from codify.runner.background_titles.service import (
    BACKGROUND_TITLE_INFERENCE_TIMEOUT_SECONDS,
    BACKGROUND_TITLE_INSTRUCTIONS,
    BackgroundTitleContext,
)

_logger = logging.getLogger("codify.runner.background_titles.codex_native")
...
async def generate_background_title(context: BackgroundTitleContext) -> str | None:
    ...
    from codify.runner.native.orchestration import _codex_native_model_from_spec
    ...
    with tempfile.TemporaryDirectory(prefix="codify-codex-title-") as temp_dir:

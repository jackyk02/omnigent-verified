...
:mod:`codify.policies.schema`): ``tool_call`` events carry
...
YAML usage::
    ...
    policies:
      gdrive_guard:
        type: function
        function:
          path: codify.policies.builtins.google.gdrive_policy
          arguments: {read_all: false, read_files: ["1AbC..."], allow_create: true}
      gmail_guard:
        type: function
        function:
          path: codify.policies.builtins.google.gmail_policy
...
from codify.policies.schema import PolicyEvent, PolicyResponse, StateUpdateEntry
...
POLICY_REGISTRY: list[dict[str, Any]] = [  # type: ignore[explicit-any]
    ...
    {
        "handler": "codify.policies.builtins.google.gmail_policy",
        "kind": "factory",
        "name": "Gmail Access",
        "description": (
    ...
    {
        "handler": "codify.policies.builtins.google.gcalendar_policy",
        "kind": "factory",

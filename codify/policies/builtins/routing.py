...
def _extract_response_text(response: object) -> str:
    ...
    - ``output[0].content[0].text`` (codify
      :class:`~codify.llms.types.Response`).
    ...
    YAML usage::
        ...
        policies:
          intent_based_authorization:
            type: function
            function:
              path: codify.policies.builtins.routing.intent_based_authorization
    """
...
POLICY_REGISTRY: list[dict[str, object]] = [
    ...
    {
        "handler": "codify.policies.builtins.routing.intent_based_authorization",
        "kind": "factory",

...
:mod:`codify.spec.types`; runtime evaluation types live
here.
...
:mod:`codify.policies` package entry point).
"""
...
from codify.spec.types import Phase, PolicyAction, StateUpdate

if TYPE_CHECKING:
    from codify.llms.client import Client
    from codify.llms.types import Response, ResponseStreamEvent
...
# (``codify.runner.app`` and ``codify.runtime.harnesses._scaffold``)
...
class EvaluationContext:
    ...
    :param llm_client: An :class:`~codify.policies.types.PolicyLLMClient`
...
class PolicyLLMClient:
    ...
    Wraps an :class:`~codify.llms.client.Client` with the
    ...
    :param _client: The underlying multi-provider LLM client.
        An :class:`~codify.llms.client.Client` instance
    ...
    async def create(
        ...
        **kwargs: object,
        ...
        :returns: A :class:`~codify.llms.types.Response`.

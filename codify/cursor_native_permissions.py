...
``AskQuestion`` tool. To surface both in the Codify web UI (so a user can
...
from codify.cursor_native_bridge import capture_cursor_pane, send_cursor_pane_keys
...
from codify.cursor_native_forwarder import _discover_store, _read_blob_rows
...
# sometimes leaves a pending marker long enough for Codify to mirror a card.
...
def cursor_tool_call_elicitation_id(session_id: str, tool_call_id: str) -> str:
    """Return the deterministic Codify elicitation id for a gated tool call.

...
:func:`codify.hermes_native_forwarder.forward_hermes_store_to_session` poll
...
:mod:`codify.cursor_native_status`. Persisting the posted-count means a
...
def clear_hermes_status_state(bridge_dir: Path) -> None:
    ...
    Sibling of :func:`codify.hermes_native_forwarder.clear_hermes_bridge_state`:

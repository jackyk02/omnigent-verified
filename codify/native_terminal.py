...
async def bind_session_runner(
    ...
    try:
        ...
        raise click.ClickException(
            f"Couldn't reach the Codify server to bind session {session_id!r} ({exc!r}). "
        ...
        raise click.ClickException(
            f"Couldn't reach the Codify server to bind session {session_id!r}: connection "
        ...
        raise click.ClickException(
            f"Timed out binding session {session_id!r}: the Codify server is responding too "

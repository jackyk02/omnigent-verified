...
from codify.db import CodifyBase, ConversationBase
...
if config.config_file_name is not None:
    ...
    # ``codify run -p`` would otherwise dump 3 INFO lines
...
target_metadata = [CodifyBase.metadata, ConversationBase.metadata]

# Allow overriding the DB URL via environment variable.
db_url = os.environ.get("CODIFY_DB_URL")
if db_url:

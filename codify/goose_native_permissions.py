...
``prompt_tool_confirmation``). To also surface those approvals in the Codify
...
Enter in the terminal). Mirrors :mod:`codify.cursor_native_permissions`; the
...
from codify.goose_native_bridge import capture_goose_pane, send_goose_pane_keys
...
def goose_permission_elicitation_id(session_id: str, token: str) -> str:
    """Return the deterministic Codify elicitation id for a Goose prompt.

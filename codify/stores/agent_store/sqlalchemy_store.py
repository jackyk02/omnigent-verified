...
from codify.db.enum_codecs import encode_agent_kind
...
from codify.entities import Agent, PagedList
...
class SqlAlchemyAgentStore(AgentStore):
    ...
    def _session_id_for_agent(self, agent_id: str) -> str | None:
        ...
        this must run on the conversation engine, not the Codify engine that
    ...
    def get(self, agent_id: str) -> Agent | None:
        ...
        # Runs outside the Codify session: the lookup targets the AP DB.

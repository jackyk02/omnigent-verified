...
from codify._platform import installed_interactive_shells
...
def public_agent_name(name: str | None) -> str | None:
    ...
    name (e.g. ``pi-native-ui``) that is an Codify implementation detail. When
...
def native_shell_terminal_spec() -> dict[str, Any]:
    ...
    (:func:`codify._platform.installed_interactive_shells`), keyed and

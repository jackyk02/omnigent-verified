...
if TYPE_CHECKING:
    ...
    from codify.server.smart_routing import RoutingClient
    from codify.spec.types import LLMConfig, PolicySpec
...
class RuntimeCaps:
    ...
    :param sandbox_enabled: Whether to use ``srt`` sandboxing for
        ...
        ``CODIFY_CONTAINER_RUNTIME`` environment variable; the
    ...
    :param policy_llm_connection_factory: Optional callable invoked
        ...
        :class:`~codify.policies.types.PolicyLLMClient`. When
    ...
    # Registered by the host application (e.g. codifys_app.py) to

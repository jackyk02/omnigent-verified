...
from codify.runtime import inflight_text, pending_elicitations
...
def publish(conversation_id: str, event: dict[str, Any]) -> None:
    ...
    :param event: The event dict to publish, e.g.
        ...
        the Codify route layer validates each emitted dict against
...
async def subscribe(
    ...
    *,
    ...
    # registration, before the ``yield`` below suspends. On the Codify event

...
Enables built-in tools provided by codify. Each entry is either a plain
...
Codify may append small framework-owned lifecycle or metadata instructions
...
registration boundary (`codify.cli._resolve_bundle_env_vars`), never
...
**Security note — SSRF risk:** The codify server makes outbound HTTP

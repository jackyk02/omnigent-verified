"""OpenClaw/acpx config bridge for ``codify setup``.

Reads a user's acpx/OpenClaw agent registry and converts it into Codify's
...
from codify.onboarding.acp_auth import AcpAgentEntry, acp_agents, slugify
...
class OpenClawAgentEntry:
    ...
    def command_line(self) -> str:
        """Return the shell command Codify should persist."""

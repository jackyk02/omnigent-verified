"""Goose readiness + config reporting for ``codify setup``.

Unlike :mod:`codify.onboarding.cursor_auth`, Codify manages **no** Goose
...
from codify.onboarding.harness_install import GOOSE_KEY, harness_cli_installed

#: Override for the goose binary path (mirrors codify.goose_native).
...
def _goose_binary() -> str | None:
    """Resolve the goose executable (``CODIFY_GOOSE_PATH`` override, else PATH)."""

...
description: Detect Python agent frameworks from code imports and map them to Codify executor types. Load when the user has existing agent code to integrate.
---

# Framework Detection

When the user has existing Python code they want to integrate into
Codify, detect the framework from import statements and recommend
...
- Explain that Codify does not currently have a supported executor for that framework.
...
- The issue URL format: `https://github.com/dbczumar/codify/issues/new?title=...&body=...`

...
Codify reads this file to pick per-harness model defaults, base URLs,
...
class UcodeWorkspaceState:
    ...
    :param claude_models: Mapping of tier to model id,
        ...
        :data:`codify.claude_native._UCODE_CLAUDE_CUSTOM_TIER`) to the
...
def read_ucode_state(workspace_url: str) -> UcodeWorkspaceState | None:
    ...
    state-version changes; it validates the keys Codify consumes rather

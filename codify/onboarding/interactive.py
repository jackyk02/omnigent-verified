...
selection primitives used by ``codify setup --no-internal-beta`` (and any
future configure noun). The look reproduces
:mod:`codify.repl._theme_picker`:
...
from :mod:`codify.repl._theme_picker` rather than imported: that

...
'codify[cwsandbox]'``) imported lazily, so the provider can be listed
...
HOST_IMAGE_ENV_VAR = "CODIFY_CWSANDBOX_HOST_IMAGE"
SANDBOX_ENV_PASSTHROUGH_ENV_VAR = "CODIFY_CWSANDBOX_SANDBOX_ENV"
MAX_LIFETIME_ENV_VAR = "CODIFY_CWSANDBOX_MAX_LIFETIME_S"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "Install it with `pip install 'codify[cwsandbox]'`, then set "
...
class CWSandboxLauncher(SandboxLauncher):
    ...
    def keep_alive(self, sandbox_id: str) -> None:
        ...
        click.echo(
            ...
            "its max_lifetime_seconds (override CODIFY_CWSANDBOX_MAX_LIFETIME_S)."
        )

...
existing :class:`~codify.onboarding.sandboxes.base.SandboxLauncher`
interface and the newer pluggable surface in
:mod:`codify.onboarding.sandboxes.registry`.
"""
...
class SandboxCapabilities:
    ...
    :param cli_bootstrap: Provider supports ``codify sandbox create`` /

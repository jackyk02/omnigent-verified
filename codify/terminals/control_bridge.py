...
Alternative transport to :mod:`codify.terminals.ws_bridge`. Where the PTY
...
native cost-approval popup (:mod:`codify.native_cost_popup`) does not render
...
async def bridge_tmux_control_to_websocket(
    ...
    *,
    ...
    :func:`codify.terminals.ws_bridge.bridge_tmux_pty_to_websocket` with the

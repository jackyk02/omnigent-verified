...
See ``designs/CODIFY_TERMINAL_BRIDGE.md`` for the design and the
:class:`TerminalInstance` documentation in
:mod:`codify.inner.terminal` for the underlying tmux machinery.
"""

from codify.terminals.registry import TerminalListEntry, TerminalRegistry

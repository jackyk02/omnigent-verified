...
# the full codify.tools package in the subprocess (it pulls
# in heavy deps); the constant is a string literal anyway.
_TOOL_MARKER_ATTR = "_codify_tool_metadata"

# Reserved parameter name — kept in sync with
# ``codify_client.tools._schema.STATE_PARAM_NAME``. We hardcode
...
def _construct_tool_state(state_root: str | None) -> Any:
    ...
    from codify_client.tools import ToolState as _ToolState

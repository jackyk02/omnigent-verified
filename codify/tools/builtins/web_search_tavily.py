...
# traffic from the Codify provider is attributable.
_CLIENT_SOURCE = "codify"


def _tavily_url() -> str:
    """Resolve the Tavily Search URL; ``CODIFY_TAVILY_BASE_URL`` overrides for tests."""
    return os.environ.get("CODIFY_TAVILY_BASE_URL", _DEFAULT_TAVILY_URL)

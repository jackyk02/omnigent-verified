...
_CLIENT_SOURCE = "codify"


def _nimble_url() -> str:
    """Resolve the Nimble Search URL; ``CODIFY_NIMBLE_BASE_URL`` overrides for tests."""
    return os.environ.get("CODIFY_NIMBLE_BASE_URL", _DEFAULT_NIMBLE_URL)

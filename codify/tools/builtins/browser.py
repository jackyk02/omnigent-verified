...
(``codify/runner/tool_dispatch.py`` — the ``_BROWSER_TOOLS`` branch),
...
Descriptions for the five browser tools that drive the Codify
...
class BrowserNavigateTool(Tool):
    ...
    def description(cls) -> str:
        ...
        return (
            "Open or navigate the Codify desktop app's embedded "
            "browser pane to a URL. Auto-opens the pane if it isn't "
            "open yet. Requires the Codify desktop window to be "

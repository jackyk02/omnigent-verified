...
# paths strip this marker and expose ``codify.closed=true`` instead.
...
class SysSessionSendTool(Tool):
    ...
    Sub-agent sessions are separate Codify agent sessions (own
    ...
    :class:`codify.runtime.workflow._AsyncToolHandle`:
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "are separate Codify agent sessions (own conversation, "
...
def _spec_opts_into_harness_override(spec: Any) -> bool:
    ...
    ``codify/runner/tool_dispatch.py`` (``_subagent_allowed_harnesses``) so
...
def _build_sys_session_send_schema(
    ...
    description = (
        ...
        if sub_specs
            ...
            "Child sessions are separate Codify agent sessions (own "
...
class SysSessionShareTool(Tool):
    ...
    (:class:`codify.spec.types.SharePolicy`), which is its sole gate:
...
class SysSessionCreateTool(Tool):
    ...
    The child is a separate Codify agent session — its own
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "separate Codify agent session — its own conversation, "
                    ...
                    "properties": {
                        ...
                        "config_path": {
                            ...
                            "description": (
                                ...
                                "'.codify/agent-configs/helper.yaml'. "

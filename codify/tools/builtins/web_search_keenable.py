...
# so traffic from the Codify provider is attributable.
_CLIENT_TITLE = "Codify"


def _keenable_base_url() -> str:
    """Resolve the Keenable base URL; ``CODIFY_KEENABLE_BASE_URL`` overrides for tests."""
    return os.environ.get("CODIFY_KEENABLE_BASE_URL", _DEFAULT_KEENABLE_URL).rstrip("/")

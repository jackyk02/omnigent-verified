...
def _run_google(query: str, config: dict[str, str]) -> str:
    ...
    """
    from codify.tools.builtins.web_search_google import (
        _search_google,
    )
...
def _run_perplexity(query: str, config: dict[str, str]) -> str:
    ...
    """
    from codify.tools.builtins.web_search_perplexity import (
        _search_perplexity,
    )
...
def _run_nimble(query: str, config: dict[str, str]) -> str:
    ...
    :returns: Formatted results or an error message.
    """
    from codify.tools.builtins.web_search_nimble import (
        _search_nimble,
    )
...
def _run_duckduckgo(query: str, config: dict[str, str]) -> str:
    ...
    :returns: Formatted results or an error message.
    """
    from codify.tools.builtins.web_search_duckduckgo import (
        _search_duckduckgo,
    )

...
from codify_client.tools import ToolMetadata, get_tool_metadata

from codify.runner.identity import strip_runner_auth_secrets
from codify.spec.types import LocalToolInfo, SandboxConfig
from codify.tools._pep723 import parse_inline_metadata
from codify.tools._srt import wrap_with_srt
...
class LocalPythonTool(Tool):
    ...
    # ``codify.runtime.workflow._dispatch_local_python_tool_async``
    ...
    def _prepend_srt(
        ...
        *,
        ...
        shared :func:`~codify.tools._srt.wrap_with_srt` helper

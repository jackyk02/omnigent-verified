...
Codify continues to use canonical harness identifiers internally.
"""

from __future__ import annotations

from codify.harness_plugins import harness_aliases, native_harnesses

HARNESS_ALIASES: dict[str, str] = harness_aliases()

# Canonical native-CLI harness spellings. These harnesses type messages into
# a resident terminal process and mirror their transcript back to Codify, so
# the runner must not replay Codify history or treat a completed queue call

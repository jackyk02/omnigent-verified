...
from codify.db.db_models import LABEL_VALUE_MAX_LEN
from codify.entities.conversation import (
    ITEM_TYPE_TO_DATA_CLS,
)
from codify.harness_capabilities import ForkHistory
...
from codify.server.host_registry import HostRegistry
...
# ``codify.server.routes.sessions`` logger after the split into this package.
_logger = logging.getLogger("codify.server.routes.sessions")
...
_CLAUDE_NATIVE_SUBAGENT_ID_LABEL_KEY = "codify.claude_native.subagent_id"


_CLAUDE_NATIVE_TOOL_USE_ID_LABEL_KEY = "codify.claude_native.tool_use_id"


_CLAUDE_NATIVE_DESCRIPTION_LABEL_KEY = "codify.claude_native.description"
...
_CODEX_NATIVE_SUBAGENT_THREAD_ID_LABEL_KEY = "codify.codex_native.subagent_thread_id"


_CODEX_NATIVE_SUBAGENT_PARENT_THREAD_ID_LABEL_KEY = "codify.codex_native.parent_thread_id"


_CODEX_NATIVE_SUBAGENT_TOOL_CALL_ID_LABEL_KEY = "codify.codex_native.collab_tool_call_id"


_CODEX_NATIVE_SUBAGENT_PROMPT_LABEL_KEY = "codify.codex_native.prompt"


_CODEX_NATIVE_SUBAGENT_NICKNAME_LABEL_KEY = "codify.codex_native.agent_nickname"


_CODEX_NATIVE_SUBAGENT_ROLE_LABEL_KEY = "codify.codex_native.agent_role"


_CODEX_NATIVE_COLLABORATION_MODE_LABEL_KEY = "codify.codex_native.collaboration_mode"
...
_LAST_CONTEXT_TOKENS_LABEL_KEY: str = "codify.last_context_tokens"


_LAST_CONTEXT_WINDOW_LABEL_KEY: str = "codify.last_context_window"


_LAST_TASK_ERROR_CODE_LABEL_KEY: str = "codify.last_task_error_code"


_LAST_TASK_ERROR_MESSAGE_LABEL_KEY: str = "codify.last_task_error_message"
...
_CLAUDE_NATIVE_WRAPPER_LABEL_KEY = "codify.wrapper"


_CLAUDE_NATIVE_WRAPPER_LABEL_VALUE = CLAUDE_NATIVE_CODING_AGENT.wrapper_label


_CLAUDE_NATIVE_UI_LABEL_KEY = "codify.ui"
...
_MODEL_OPTIONS_ENDPOINT_BY_WRAPPER: dict[str, str] = {
    ...
    # (Codify provider OR pi's own ``/login``) — see ``_fetch_model_options``.
}
...
def _sessions_facade() -> Any:
    ...
    import codify.server.routes.sessions as facade

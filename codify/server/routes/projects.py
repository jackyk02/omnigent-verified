...
from codify.entities import Project
...
def create_projects_router(
    ...
    async def create_project(
        ...
        :raises CodifyError: 401 if unauthenticated in multi-user mode, 409
    ...
    async def list_projects(request: Request) -> dict[str, Any]:
        ...
        :raises CodifyError: 401 if unauthenticated in multi-user mode.
        """
        user_id = require_user(request, auth_provider)
    ...
    async def get_project(request: Request, project_id: str) -> dict[str, Any]:
        ...
        :raises CodifyError: 401 if unauthenticated, 404 if not found / not
            owned by the caller.
        """
        user_id = require_user(request, auth_provider)

...
from codify.server import presence
...
from codify.server.routes._codex_elicitation import parse_codex_elicitation_request
...
from codify.telemetry.events import SessionDeletedEvent as _TelSessionDeletedEvent
from codify.telemetry.events import SessionStoppedEvent as _TelSessionStoppedEvent
from codify.telemetry.installation_id import get_installation_id as _get_installation_id
from codify.tools.client_specified import parse_client_side_tool_specs
...
def create_sessions_router(
    ...
    from codify.server.routes.sessions.routes_agent import register_agent_routes
    from codify.server.routes.sessions.routes_browser import register_browser_routes
    from codify.server.routes.sessions.routes_core import register_core_routes
    from codify.server.routes.sessions.routes_elicitations import register_elicitations_routes
    from codify.server.routes.sessions.routes_events import register_events_routes
    from codify.server.routes.sessions.routes_hooks import register_hooks_routes
    from codify.server.routes.sessions.routes_items import register_items_routes
    from codify.server.routes.sessions.routes_permissions import register_permissions_routes
    from codify.server.routes.sessions.routes_resources import register_resources_routes

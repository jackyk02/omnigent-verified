...
Lets a machine with spare CPU do speech-to-text for an codify server
...
points ``CODIFY_DICTATION_REMOTE_URL`` at this worker; it relays takes
...
The same ``CODIFY_DICTATION_*`` env vars configure the worker itself
...
def create_worker_app() -> FastAPI:
    ...
    app = FastAPI(title="codify dictation worker")

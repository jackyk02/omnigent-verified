...
Sibling to :class:`codify.stores.permission_store.PermissionStore`
...
from codify.db.enum_codecs import decode_account_token_kind, encode_account_token_kind
from codify.db.utils import get_or_create_engine, make_managed_session_maker
from codify.entities import Account, AccountToken
from codify.server.auth import RESERVED_USER_LOCAL, RESERVED_USER_PUBLIC
...
class SqlAlchemyAccountStore:
    ...
    :param storage_location: SQLAlchemy database URI, e.g.
        ``"sqlite:///codify.db"``. Shares the connection pool
    ...
    def create_user_with_password(
        ...
        *,
        ...
        :param password_hash: Pre-hashed password (see
            :mod:`codify.server.passwords`). Plaintext never
    ...
    def set_admin(self, user_id: str, is_admin: bool) -> None:
        ...
        (:func:`codify.server.admin_list.promote_if_listed`), which
    ...
    def get_password_hash(self, user_id: str) -> str | None:
        ...
        :func:`codify.server.passwords.verify_password` — never

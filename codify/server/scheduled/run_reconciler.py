...
The fire path (:mod:`codify.server.scheduled.fire`) records a
...
:func:`codify.server.session_live_state.persist_scheduled_run_completion`,
...
if TYPE_CHECKING:
    from codify.entities import ScheduledTaskRun

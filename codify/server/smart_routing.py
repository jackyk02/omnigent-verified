...
from codify.model_metadata import ModelCostTier, ModelIntent, ModelWireAPI
...
class ExternalRoutingClient:
    ...
    or any endpoint speaking the ``codify.api.routing.v1`` proto)
    ...
    async def route(
        ...
        from codify.api.routing.v1 import routing_pb2 as pb

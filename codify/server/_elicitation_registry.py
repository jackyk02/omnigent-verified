...
from codify.server.schemas import ElicitationResult
...
class _PreResolvedHarnessElicitation:
    ...
    :param session_id: Codify session id that issued the resolution, e.g.
        ``"conv_abc123"``.
...
# race between a native client answering instantly and the Codify hook
...
def reset_for_tests() -> None:
    ...
    :func:`codify.runtime.pending_elicitations.reset_for_tests`.

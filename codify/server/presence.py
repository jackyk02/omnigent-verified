...
:mod:`codify.runtime.session_stream`, the registry is process-local
...
# subscriber registry in ``codify.runtime.session_stream``.
...
def reset_for_tests() -> None:
    ...
    ``codify.server._elicitation_registry.reset_for_tests`` —

...
:class:`~codify.native_server_transport.NativeServerTransport`. It is
...
from codify.native_server_transport import NativePrompt, NativeServerTransport
...
class NativeServerHarness(Executor):
    ...
    async def run_turn(
        ...
        :param messages: Conversation history; the latest user message is
            delivered.
        :param tools: Codify tool schemas (ignored — native owns tools).

...
:mod:`codify.inner.seatbelt_sandbox` calls
...
:mod:`codify.sandbox.bwrap`).

Like ``linux_bwrap`` on Linux, the Seatbelt backend is the macOS
platform default (selected by :func:`codify.inner.sandbox._default_sandbox_for_platform`
...
from codify.inner.seatbelt_sandbox import SeatbeltSandboxBackend

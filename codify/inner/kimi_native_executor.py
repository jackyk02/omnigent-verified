"""Executor that bridges Codify web-chat turns into the native Kimi TUI.

It does not launch ``kimi`` — the ``codify kimi`` wrapper already
...
This is a DIFFERENT executor from the headless :class:`~codify.inner.
...
from codify.kimi_native_bridge import BRIDGE_DIR_ENV_VAR, inject_user_message

logger = logging.getLogger(__name__)


class KimiNativeExecutor(Executor):
    """Harness-side executor for ``codify kimi`` web-UI turns.

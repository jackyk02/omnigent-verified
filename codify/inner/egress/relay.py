...
``Proxy-Authorization: Basic <base64(codify:token)>`` header on
every inbound connection, with the token shared between parent and
helper via :class:`codify.inner.sandbox.SandboxPolicy.
...
net protection gain. See ``codify/inner/os_env.py:

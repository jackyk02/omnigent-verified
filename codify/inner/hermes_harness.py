...
around a :class:`codify.inner.hermes_executor.HermesExecutor`
...
from codify.inner.hermes_executor import HermesExecutor
...
_ENV_HERMES_PATH = "CODIFY_HERMES_PATH"
...
def _build_hermes_executor() -> Executor:
    ...
    :raises FileNotFoundError: If ``hermes`` is not on PATH and
        ``CODIFY_HERMES_PATH`` (legacy ``HARNESS_HERMES_PATH``) isn't set.
    """

"""OpenTelemetry tracing integration for Codify.
...
from codify.runtime.telemetry import (
    parse_provider_name,
...
def enable_tracing() -> None:
    """Enable OTel tracing globally for all Codify sessions."""
...
def _tracer() -> Tracer:
    ...
    return trace.get_tracer("codify")
...
class TracingContext:
    ...
    def __init__(self, session_id: str | None = None) -> None:
        ...
        # Codify session (conversation) id, stamped as ``session.id`` on
    ...
    def start_agent_span(
        ...
        if parent is None:
            ...
            from codify.runtime.telemetry import SENTINEL_PARENT_SPAN_ID

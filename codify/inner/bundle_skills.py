...
def ensure_bundle_plugin_manifest(
    ...
    manifest_path.write_text(
        json.dumps(
            {
                "name": name,
                "description": f"Bundled skills for codify agent {name!r}",
            },
            indent=2,
        )
        + "\n",

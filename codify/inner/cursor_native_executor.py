"""Executor that bridges Codify web-chat turns into the native Cursor TUI.

It does not launch cursor-agent — the ``codify cursor`` wrapper already
...
class CursorNativeExecutor(Executor):
    """Harness-side executor for ``codify cursor`` web-UI turns.

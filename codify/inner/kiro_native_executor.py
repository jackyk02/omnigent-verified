"""Executor that bridges Codify web-chat turns into the native Kiro TUI."""
...
from codify.kiro_native_bridge import KIRO_NATIVE_BRIDGE_DIR_ENV_VAR, inject_user_message


class KiroNativeExecutor(Executor):
    """Harness-side executor for ``codify kiro`` web-UI turns."""

...
Wraps a :class:`codify.inner.cursor_executor.CursorExecutor`, which
...
- ``HARNESS_CURSOR_PERMISSION_MODE``: Codify permission stance
...
from codify.inner.cursor_executor import CursorExecutor
...
def _resolve_os_env() -> OSEnvSpec:
    ...
    Decodes the JSON-encoded dict Codify serialized via

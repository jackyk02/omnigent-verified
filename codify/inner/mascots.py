"""Static terminal mascot art for Codify startup banners."""
...
# ``codify.cli``. Otto's starfish magenta-pink — the Codify brand accent.
...
def random_mascot_color() -> str:
    ...
    :returns: Hex color string for the Codify accent,
        e.g. ``"#F43BA6"``.
    """
...
def random_mascot_lines() -> list[str]:
    ...
    mascot API, but the TUI now uses the single static Codify mascot.

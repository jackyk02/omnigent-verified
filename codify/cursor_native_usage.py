...
the SQLite chat store (tailed by :mod:`codify.cursor_native_forwarder`) and
...
:func:`codify.cursor_native_bridge.write_hooks_config`) whose command runs
...
def _cli_record_usage(bridge_dir: Path) -> int:
    ...
    (:func:`codify.cursor_native_status.record_turn_end`) on EVERY firing — even
...
def _main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="codify.cursor_native_usage")

...
from codify.llms.adapters._content import parse_data_uri
...
from codify.model_metadata import ModelMetadata, ModelReasoningMode
from codify.reasoning_effort import ANTHROPIC_EFFORTS, validate_effort_or_llm_error
...
def _build_headers(
    ...
    :raises CodifyError: If no API key is provided.
    """

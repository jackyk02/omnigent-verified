...
class VertexAdapter(GeminiAdapter):
    ...
    def _get_base_url(self) -> str:
        ...
        :raises CodifyError: Always — Vertex requires connection_params
    ...
    async def chat_completions(
        ...
        *,
        ...
        :returns: Chat Completions response dict or async chunk
            iterator.
        :raises CodifyError: If ``connection_params`` is missing
...
def _resolve_vertex_params(
    ...
    :raises CodifyError: If params are missing or incomplete.
    """

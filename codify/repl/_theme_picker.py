...
- :func:`startup_theme_picker` — interactive arrow-key menu shown on
  ...
  default selection.  Persists the choice to ``~/.codify/config.yaml``.
...
from codify_ui_sdk.terminal._config import update_user_config
from codify_ui_sdk.terminal._theme import (
    DARK_THEME,
    LIGHT_THEME,
    TerminalTheme,
    TerminalThemeName,

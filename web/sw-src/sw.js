// Codify installability / update-only service worker (hand-rolled).
//
// Codify is a cloud app with NO offline mode, so this worker deliberately:
...
const CACHE_NAME = `codify-pwa-${BUILD_VERSION}`;

...
final class SettingsStoreTests: XCTestCase {
  ...
  func testKnownServerURLMatchesByOrigin() {
    // A recorded server URL carries the workspace mount (/ml/codifys); a deep
    ...
    store.rememberRecentServer(
      URL(string: "https://my-workspace.cloud.databricks.com/ml/codifys")!)

    let known = store.knownServerURL(forOrigin: "https://my-workspace.cloud.databricks.com")
    XCTAssertEqual(
      known?.absoluteString, "https://my-workspace.cloud.databricks.com/ml/codifys")
  }

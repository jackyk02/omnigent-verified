...
final class DeepLinkTests: XCTestCase {
  ...
  func testAcceptsDashedUuidId() {
    ...
    let dl = DeepLink.parse(URL(string: "codify://localhost:8000/c/\(dashed)")!)
    XCTAssertEqual(dl?.origin, "http://localhost:8000")
  ...
  func testAcceptsLegacyConvPrefixedId() {
    ...
    let dl = DeepLink.parse(URL(string: "codify://localhost:8000/c/conv_\(hex)")!)
    XCTAssertEqual(dl?.path, "/c/conv_\(hex)")
  }

  func testAcceptsLegacyAgPrefixedId() {
    let dl = DeepLink.parse(URL(string: "codify://localhost:8000/c/ag_\(hex)")!)
  ...
  func testAcceptsUppercaseHexId() {
    ...
    let dl = DeepLink.parse(URL(string: "codify://localhost:8000/c/\(upper)")!)
    XCTAssertEqual(dl?.path, "/c/\(upper)")
  }

  func testRejectsNonCodifyScheme() {
  ...
  func testRejectsLinkWithNoHost() {
    XCTAssertNil(DeepLink.parse(URL(string: "codify://")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify:///c/\(hex)")!))
  }

  func testRejectsNonConversationPaths() {
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/inbox")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/settings/appearance")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)/extra")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/")!))
  }
  ...
  func testRejectsSmuggledQueryViaEncodedQuestionMark() {
    let url = URL(string: "codify://localhost:8000/c/\(hex)%3Fview=terminal")!
  ...
  func testRejectsSmuggledFragmentViaEncodedHash() {
    let url = URL(string: "codify://localhost:8000/c/\(hex)%23frag")!
  ...
  func testRejectsEncodedPathSeparator() {
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)%2Fextra")!))
  }
  ...
  func testRejectsEncodedDotAndDotDot() {
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)%2E.")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/%2e%2e")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/..")!))
  }
  ...
  func testRejectsControlCharacters() {
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)%00x")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)%0Ax")!))
    XCTAssertNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)%7Fx")!))
  }

  /// A malformed percent-escape leaves a literal `%` in `URL.path`; `%` is not
  /// in the id grammar.
  func testRejectsMalformedPercentEscape() {
    let url = URL(string: "codify://localhost:8000/c/\(hex)%zz")!
    XCTAssertNil(DeepLink.parse(url))
  }
  ...
  func testAcceptsBenignNonCanonicalIds() {
    ...
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/conv_abc")!))
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/x")!))
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/not-a-uuid")!))
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex.dropLast())")!))
    // 31 hex
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/\(hex)g")!))
    // 33rd char not hex
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/host_\(hex)")!))
    // wrong legacy prefix
    XCTAssertNotNil(DeepLink.parse(URL(string: "codify://localhost:8000/c/conv_\(hex)")!))
  }

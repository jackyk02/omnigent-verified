...
struct ConnectView: View {
  ...
  var body: some View {
    VStack {
      ...
      VStack(spacing: 0) {
        Image(colorScheme == .dark ? "CodifyLogoReverse" : "CodifyLogo")
          .resizable()
          .scaledToFit()
          .frame(height: 80)
          .padding(.bottom, 12)

        Text("Enter the URL of the Codifys server.")
          .font(.system(size: 14))
          .lineSpacing(2)
  ...
  private var infoMenu: some View {
    ...
    .accessibilityLabel("About Codify")
  }
...
private enum InfoLink: Identifiable {
  ...
  var url: URL {
    switch self {
    case .website: URL(string: "https://codify.ai")!
    case .docs: URL(string: "https://codify.ai/docs")!
    case .privacy: URL(string: "https://codify.ai/privacy")!
    }
  }
}

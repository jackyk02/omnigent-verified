...
export const PINNED_CONVERSATION_IDS_STORAGE_KEY = "codify:pinned-conversation-ids";
...
export const COLLAPSED_SIDEBAR_SECTIONS_STORAGE_KEY = "codify:collapsed-sidebar-sections";
...
export const EXPANDED_PROJECT_SECTIONS_STORAGE_KEY = "codify:expanded-project-sections";
...
// `updated_at`. The `codify.pinned` label value is the epoch-ms pin time;

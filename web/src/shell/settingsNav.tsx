...
export function settingsNavGroups(
  ...
  const general: SettingsNavItem[] = [
    ...
    { id: "verifier", label: "Best-of-N Verifier", icon: GitCompareArrowsIcon },
...
// the conversation (and its ?file= etc.) is preserved. "Back to Codify"
 ...
 * Codify" and the same collapse control the conversations view uses.
 */

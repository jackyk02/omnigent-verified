 ...
 * owned by the web layer. This fills its center with "Codify — <host>" and
 ...
 *
 * When a thread is open, its title replaces the "Codify" brand label
...
export function TitleBarServerPicker({
  ...
  /** Title of the currently open thread, or null/undefined when no thread
      is selected or it has no title yet (falls back to "Codify"). */
      ...
      <DropdownMenu>
        ...
        >
          <span className="truncate font-medium">
            {threadTitle || "Codify"} — {hostOf(info.currentOrigin)}
          </span>

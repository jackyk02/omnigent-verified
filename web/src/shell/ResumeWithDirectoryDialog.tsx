 ...
 * the ``codify.fork.source_id`` label). Unlike ``ResumeChatDialog``
 ...
 * dialog falls back to the CLI reconnect command (``codify connect``)
 ...
 *   (``codify.fork.source_id``); read for host/dir/branch prefill.
 * @param serverUrl - Origin for the CLI fallback command.
 * @param wrapper - The clone's ``codify.wrapper`` label (CLI fallback).
          ...
          <div className="flex flex-col gap-2" data-testid="resume-dir-cli-fallback">
            ...
            <CliCommandBlock
              command={buildReconnectCommand({
                ...
                // owner re-registers the host (`codify host`); without one

...
describe("SubagentsPanel", () => {
  ...
  const AGENT_KIND_CASES: {
    ...
    },
    {
      ...
      labels: { "codify.wrapper": "some-other-wrapper" },
      expectedKind: "agent",
    },
  ];
  ...
  it.each(AGENT_KIND_CASES)(
    ...
    ({ labels, agentName, expectedKind }) => {
      ...
      // and generic based on the parent session's `codify.wrapper`
    ...
    mockChildTree({
      conv_root: [
        childInfo({
          ...
          labels: { "codify.wrapper": "codex-native-ui-subagent" },
        }),
      ],
    });
    ...
    mockChildTree({
      conv_root: [
        childInfo({
          ...
          tool: "claude",
          labels: { "codify.wrapper": "claude-code-native-ui-subagent" },
        }),
        childInfo({
          id: "conv_explore",

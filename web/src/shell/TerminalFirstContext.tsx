...
//
//   - `codify.wrapper === "claude-code-native-ui"` → `isClaudeNative`
//   - registered `codify.wrapper` native value    → `isNativeWrapper`
//   - `codify.ui === "terminal"`                  → `isTerminalFirst`
//
...
// label; runner-hosted SDK sessions now stamp `codify.ui` WITHOUT a
// wrapper label (their embedded terminal hosts the Codify REPL), so
...
export interface TerminalFirstContextValue {
  /** True when `codify.wrapper === "claude-code-native-ui"`. */
   ...
   * Codify REPL terminal are terminal-first but not native).
   */
  isNativeWrapper: boolean;
  /** True when `codify.ui === "terminal"` — gates the toggle + sidebar card. */

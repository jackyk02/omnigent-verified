...
function DialogContent({
  ...
  // keyboard-aware visible height as `--codify-viewport-height` on :root, so
  ...
  const iosViewportStyle: React.CSSProperties = isIOSShell()
    ? {
        ...
        top: "calc(var(--codify-viewport-height, 100lvh) / 2)",
        ...
        maxHeight:
          "calc(var(--codify-viewport-height, 100lvh) - var(--codify-safe-top, 0px) - var(--codify-safe-bottom, 0px) - 1rem)",
      }
    : {};
  return (
    <DialogPortal>

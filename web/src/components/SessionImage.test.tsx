...
const getCodifyHostConfig = vi.fn();
const hostFetch = vi.fn();

vi.mock("@/lib/host", () => ({
  getCodifyHostConfig: () => getCodifyHostConfig(),
...
describe("SessionImage (standalone, no host fetcher)", () => {
  beforeEach(() => {
    getCodifyHostConfig.mockReturnValue({ fetcher: undefined });
  });
...
describe("SessionImage (embedded, host fetcher present)", () => {
  beforeEach(() => {
    getCodifyHostConfig.mockReturnValue({ fetcher: () => {} });
  });

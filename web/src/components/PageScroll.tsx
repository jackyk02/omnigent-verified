 ...
 * (`--codify-header-height`, `--codify-inset-top/bottom`). Off the iOS shell
...
export function PageScroll({
  ...
  const style: CSSProperties = {
    paddingTop: `calc(${extraTop}${clearHeader ? " + var(--codify-header-height)" : ""}${
      insetTop ? " + var(--codify-inset-top)" : ""
    })`,
    paddingBottom: `calc(${extraBottom}${insetBottom ? " + var(--codify-inset-bottom)" : ""})`,
  };

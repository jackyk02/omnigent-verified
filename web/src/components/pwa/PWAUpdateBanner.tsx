 ...
 * let the user reload into the new build. Codify has no offline mode (cloud
...
export function PWAUpdateBanner() {
  ...
  return (
    ...
    >
      <span className="text-sm text-foreground">A new version of Codify is available.</span>

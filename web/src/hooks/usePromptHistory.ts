...
// against ~/.codify_history). Web-side, history persists across tabs and
...
const STORAGE_PREFIX = "codify:prompt-history";
 ...
 * @returns The localStorage key, e.g. ``"codify:prompt-history:conv_abc123"``.
 */

...
export interface AvailableAgent {
  ...
  // same-named `codify run` upload, but lets a newer upload supersede a
 ...
 *   wins, so a fresh `codify run agent.yaml` supersedes a stale template

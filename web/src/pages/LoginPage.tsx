...
const LAST_USERNAME_KEY = "codify.lastLoginUsername";
...
export function LoginPage() {
  ...
  return (
    <div
      ...
      style={{
        paddingTop: "var(--codify-safe-top)",
        paddingBottom: "var(--codify-safe-bottom)",
      }}
    >
      <div className="w-full max-w-sm space-y-6">
        <div className="space-y-1 text-center">
          <h1 className="text-2xl font-semibold tracking-tight">Sign in</h1>
          <p className="text-sm text-muted-foreground">Welcome to Codify.</p>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5 font-mono">
            CODIFY_ACCOUNTS_INIT_ADMIN_PASSWORD
          </code>
          .
        </p>
      </div>

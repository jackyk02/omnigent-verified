// Mirrors sdks/python-client/codify_client/_events.py.
//
...
// see `codify/server/schemas.py` for canonical Pydantic models:
//
 ...
 *
 * Emitted by the Codify server when the claude-native forwarder observes a
 ...
 * session.
 *
 * Emitted by the Codify server after a native wrapper reports an effort
 ...
 *
 * Emitted by the Codify server when the claude-native forwarder receives

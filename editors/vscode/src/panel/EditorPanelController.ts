/**
 * Sole owner of the editor-beside Codify `WebviewPanel` AND the resolved
 * server target that drives its render.
 *
 * The panel hosts the running LOCAL Codify server in a single static <iframe>
...
export class EditorPanelController {
  ...
  /** Create-or-reveal the editor-beside panel and render it. */
    ...
    this.output.appendLine("[codify] opened editor-beside panel");
  }

...
const cases = [
  ["codify/inner/foo.py", "inner"],
  ["codify/inner/claude_sdk_executor.py", "harness-claude"],
  ["codify/inner/kimi_executor.py", "harness-kimi"],
  ["codify/inner/kiro_native_harness.py", "harness-kiro"],
  ["web/src/main.tsx", "web"],
  ["web/ios/App.swift", "mobile-app"],
  ["web/electron/main.ts", "desktop-app"],
  ["codify/server/api.py", "server"],
];

...
AUTHOR = "Codify maintainers"
# Average adult reading speed; used only for the "N min read" byline estimate.
_WORDS_PER_MINUTE = 200

WHATS_NEXT = """## What's Next

Install or upgrade Codify:

```bash
uv tool install --python 3.12 codify   # or: pip install "codify"
```

- Star the project and file issues on [GitHub](https://github.com/codify-ai/codify).
- Join the conversation on our [Discord](https://discord.gg/codify).
- Browse the [docs](https://codify.ai/docs) to go deeper."""

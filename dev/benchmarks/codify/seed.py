...
Run standalone::
    ...
    uv run --no-sync dev/benchmarks/codify/seed.py \
...
# Allow ``uv run <path>`` (no package context) to import codify + siblings.
...
# FTS5 mirror row written per item on SQLite (must match codify.db.utils

"""CodifyClient — the top-level client tying all namespaces together."""
...
class CodifyClient:
    """Typed Python client for the codify server API.
    ...
    def __init__(
        ...
        *,
        ...
        default_headers = {"Origin": CODIFY_INTERNAL_WS_ORIGIN}
        if headers:
    ...
    async def _fetch_agent_tools(
        ...
        :returns: List of tool-entry dicts with at least ``name``
            ...
            predates F1.
        :raises CodifyError: If the agents endpoint returns
            a non-2xx (e.g. 404).
        """

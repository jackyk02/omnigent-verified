...
:class:`codify.server.schemas.SessionResponse`. Note that the
``Session`` class exported from :mod:`codify_client._session` is
...
this module's ``Session`` from :mod:`codify_client.__init__` —
...
class SessionEventInput:
    """
    Client-side mirror of :class:`codify.server.schemas.SessionEventInput`.
...
class Session:
    """
    Client-side mirror of :class:`codify.server.schemas.SessionResponse`.
    ...
    Note: distinct from :class:`codify_client._session.Session`
    (re-exported as ``codify_client.Session``), which is a
    ...
    :param external_session_id: Runtime-native session id this
        ...
        ``codify claude`` sessions). ``None`` for regular AP-only
        conversations.
...
class SessionsNamespace:
    ...
    :param http: Pre-built ``httpx.AsyncClient`` shared with the
        parent :class:`CodifyClient`. Owned by the parent;
    ...
    async def create(
        ...
        *,
        ...
        :raises CodifyError: If the server returns a non-2xx
            status.
        """
    ...
    async def bind_runner(
        ...
        *,
        ...
        :raises CodifyError: On non-2xx status (404 when the
    ...
    async def set_model_override(
        ...
        *,
        ...
        :param silent: When ``True``, persist without triggering the
            ...
            desired feedback.
        :returns: The updated :class:`Session` snapshot.
        :raises CodifyError: On non-2xx status (400 on invalid
    ...
    async def set_archived(
        ...
        *,
        ...
        :returns: The updated :class:`Session` snapshot.
        :raises CodifyError: On non-2xx status (403 without owner
    ...
    async def set_external_session_id(
        ...
        *,
        ...
        :returns: The updated :class:`Session` snapshot.
        :raises CodifyError: On non-2xx status (400 on
    ...
    async def child_sessions_tree(
        ...
        *,
        ...
        :raises CodifyError: On non-2xx status (404 when the session does not
            exist).
        """
    ...
    async def subtree_busy(
        ...
        *,
        ...
        :func:`codify_client.child_summary_busy` predicate — the same "busy"
    ...
    async def fork(
        ...
        *,
        ...
        :returns: Raw response dict matching the ``SessionResponse``
            ...
            ``items``.
        :raises CodifyError: 404 if *source_session_id* does
    ...
    async def compact(self, session_id: str) -> None:
        ...
        :param session_id: Session/conversation identifier, e.g.
            ``"conv_abc123"``.
        :raises CodifyError: If the server returns a non-2xx status.
        """
    ...
    async def stream(
        ...
        :yields: :class:`ServerStreamEvent` envelopes whose ``type`` is a
            :class:`codify.server.schemas.ServerStreamEvent`
...
def _try_parse_envelope(raw: str) -> ServerStreamEvent | None:
    ...
    :mod:`codify.server.schemas` (e.g. ``{"type":

...
contract for custom Python tools in codify. The decorator:
...
TOOL_MARKER_ATTR = "_codify_tool_metadata"
...
def tool(
    ...
    *,
    ...
    """
    Mark a module-level function as an codify tool.
    ...
    ``codify/tools/builtins/async_inbox.py``). The author-time

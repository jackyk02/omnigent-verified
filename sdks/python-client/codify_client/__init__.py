"""codify client SDK — Python client for the codify server API.
...
Or consume semantic blocks via :class:`BlockStream`::
    ...
    from codify_client import BlockStream, pipe, skip_intermediate_ends
...
from ._errors import CodifyError, ToolCallDenied

...
async def test_device_poll_denied() -> None:
    from codify_slack.oauth import AuthorizationDeniedError
...
async def test_oidc_poll_pending_then_session_jwt() -> None:
    ...
    from codify_slack import oauth as _oauth
...
# ── Device-grant client secret (X-Codify-Client-Secret header) ─────

_HEADER = "X-Codify-Client-Secret"
